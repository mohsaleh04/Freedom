...
object AppConfig {
    ...
    const val BROADCAST_ACTION_SERVICE = "ir.saltech.freedom.action.service"
    const val BROADCAST_ACTION_ACTIVITY = "ir.saltech.freedom.action.activity"
    const val BROADCAST_ACTION_WIDGET_CLICK = "ir.saltech.freedom.action.widget.click"
