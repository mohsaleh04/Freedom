...
import ir.saltech.freedom.AppConfig.TAG_DIRECT
import ir.saltech.freedom.R
import ir.saltech.freedom.dto.ServerConfig
import ir.saltech.freedom.extension.toSpeedString
import ir.saltech.freedom.extension.toast
import ir.saltech.freedom.ui.MainActivity
import ir.saltech.freedom.util.MessageUtil
...
object V2RayServiceManager {
    ...
    fun startV2Ray(context: Context) {
        if (settingsStorage?.decodeBool(AppConfig.PREF_PROXY_SHARING) == true) {
            ...
            Log.w("START_SERVICE", context.getString(R.string.toast_warning_pref_proxysharing_short))
        } else {
            Log.i("START_SERVICE", context.getString(R.string.toast_services_start))
    ...
    private fun createNotificationChannel(): String {
        ...
        val channelName = "Freedom Background Service"
